...
word\_freq\_lab:          & continuous r.v  &
    ...
    \begin{enumerate}
        \item Some alternative features to describe SPAM email are :
        \item From name meaningful 
        \item From domain name 
        \item Blocked IP 
        \item Apostrophe in From name 
        \item From name in Auto Whitelist (AWL) 
        \item From address in User’s Block list 
        \item From address in User’s White list 
        \item Content Type 
        \item Content Boundary exists 
        \item To name meaningful 
        \item To address Undisclosed recipients 
        \item To header original 
        \item From address and To address same 
        \item Is subject present 
        \item Subject content has obfuscate words 
        \item Is forwarded message 
        \item Is reply message 
        \item Subject Reply without reference header 
        \item Is message body exists 
        \item Sensual message 
        \item Repeated double quotes in body 
        \item  Character set includes foreign language 
        \item More blank lines in body 
    \end{enumerate}    
