...
We want to compute the predictor from linear regression by least squares. However, instead of using Theorem 4.1, we use batch gradient descent to compute the coefficient vector $\hat{\beta}$. Choose the initial guess $\beta^{(0)} = (0, 0, 1)^{\top}$ and calculate the first two steps of batch gradient descent with learning rate $\eta = 0.25$.
    ...
    Firstly, we calculate the partial derivatives of the loss function with respect to coefficient vector
    
    \begin{equation*}
        \nabla L(y_{i}, f(x_{i})) = 
        \begin{pmatrix}
            \frac{\partial L(y, f(x))}{\beta_{0}} \\[1em] \frac{\partial L(y, f(x))}{\beta_{1}} \\[1em] \frac{\partial L(y, f(x))}{\beta_{2}}
        \end{pmatrix} =
        \begin{pmatrix}
    ...
    Now we substitute the values of training data in the formula to compute the 2 steps of coefficients.
    \begin{equation*}
        \beta^{1} = \beta^{0} + \frac{1}{2} \cdot \Bigg[ \begin{pmatrix} 3 \\ -3 \\ 0 \end{pmatrix} + \begin{pmatrix} -4 \\ -4 \\ -12 \end{pmatrix} + \begin{pmatrix} -1 \\ 2 \\ -1 \end{pmatrix} + \begin{pmatrix} -6 \\ 0 \\ -24 \end{pmatrix}\Bigg]
    \end{equation*}
    ...
    \begin{equation*}
        \beta^{2} = \beta^{1} + \frac{1}{2} \cdot \Bigg[ \begin{pmatrix} \frac{9}{2} \\ -\frac{9}{2} \\ 0 \end{pmatrix} + \begin{pmatrix} 58 \\ 28 \\ 174 \end{pmatrix} + \begin{pmatrix} \frac{33}{2} \\ -33 \\ \frac{33}{2} \end{pmatrix} + \begin{pmatrix} 76 \\ 0 \\ 304 \end{pmatrix}\Bigg]
    \end{equation*}
     ...
     \begin{equation*}
        \beta^{2} = \begin{pmatrix}
            -4 \\ \frac{-5}{2} \\[1em] \frac{-35}{2} 
        \end{pmatrix} + \frac{1}{2} \cdot \begin{pmatrix}
            155 \\ \frac{41}{2} \\[1em] \frac{849}{2}
        \end{pmatrix} = 
        \begin{pmatrix}
            \frac{147}{2} \\[1em] \frac{31}{2} \\[1em] \frac{919}{4}
        \end{pmatrix}   
    \end{equation*}
...
\begin{enumerate}[a)]
    ...
    \begin{equation*}
        ...
        \begin{pmatrix}
            \frac{\partial L_{2}(y_{i}, f(\mathbf{x_{i}}))}{\beta_{0}} \\[1em]
            \frac{\partial L_{2}(y_{i}, f(\mathbf{x_{i}}))}{\beta_{1}} \\[1em]
            \frac{\partial L_{2}(y_{i}, f(\mathbf{x_{i}}))}{\beta_{2}} \\[1em]
            \frac{\partial L_{2}(y_{i}, f(\mathbf{x_{i}}))}{\beta_{3}} \\[1em]
            \frac{\partial L_{2}(y_{i}, f(\mathbf{x_{i}}))}{\beta_{4}} \\[1em]
    ...
    \begin{equation*}
        ...
        \end{pmatrix} + \frac{1}{5} \cdot \begin{pmatrix}
            1 \\ 4 \\ 1 \\ 4 \\ 16 \\ 1
        \end{pmatrix} \cdot (2 - \begin{bmatrix}1 & 4 & 1 & 4 & 16 & 1 \end{bmatrix} \cdot \begin{pmatrix}
            0 \\ 0 \\ 0 \\ 0 \\ 0 \\ 0
        \end{pmatrix}) = \begin{pmatrix}
            \frac{2}{5} \\[1em] \frac{8}{5} \\[1em] \frac{2}{5} \\[1em] \frac{8}{5} \\[1em] \frac{32}{5} \\[1em] \frac{2}{5}
        \end{pmatrix}
    \end{equation*}
    ...
    \begin{equation*}
        ...
        \end{pmatrix} + \frac{1}{5} \cdot \begin{pmatrix}
            1 \\ 2 \\ 8 \\ 16 \\ 4 \\ 64
        \end{pmatrix} \cdot ( -14 - \begin{pmatrix}1 & 2 & 8 & 16 & 4 & 64 \end{pmatrix} \cdot \begin{pmatrix}
            \frac{2}{5} \\[1em] \frac{8}{5} \\[1em] \frac{2}{5} \\[1em] \frac{8}{5} \\[1em] \frac{32}{5} \\[1em] \frac{2}{5}
        \end{pmatrix}) = \begin{pmatrix}-\frac{478}{25} \\[1em] -\frac{936}{25} \\[1em] -\frac{3894}{25} \\[1em] -\frac{7768}{25} \\[1em] -\frac{1792}{25} \\[1em] -\frac{31222}{25}\end{pmatrix}
    \end{equation*}
    ...
    \begin{equation*}
        \beta^{1} = \begin{pmatrix}
            -\frac{12}{5} \\[1em] -4 \\[1em] -22 \\[1em] -\frac{216}{5} \\[1em] -\frac{24}{5} \\[1em] -\frac{894}{5}
        \end{pmatrix}
    \end{equation*}
    For the second step we have:
    \begin{equation*}
    ...
    \begin{equation*}
        ...
        \end{pmatrix} \cdot ( \begin{pmatrix}
            1 \\ -11
        \end{pmatrix} + \begin{pmatrix}\frac{56}{5}\\ \frac{5380}{5}\end{pmatrix})
    \end{equation*}
    
    \begin{equation*}
        \beta^{2} = \begin{pmatrix}-\frac{12}{5} \\[1em] -4 \\[1em] -22 \\[1em] \frac{216}{5} \\[1em] -\frac{24}{5} \\[1em] -\frac{894}{5}\end{pmatrix}+\begin{pmatrix}\frac{5436}{25} \\[1em] \frac{16186}{25} \\[1em] 430 \\[1em] 1290 \\[1em] \frac{48436}{25} \\[1em] 860\end{pmatrix} = \begin{pmatrix}\frac{5376}{25} \\[1em] \frac{16086}{25} \\[1em] 408\\ \frac{6234}{5} \\[1em] \frac{48316}{25} \\[1em] \frac{3406}{5}\end{pmatrix}
    \end{equation*}
